...
2. **OpenAPI File**: Ensure you have the HubSpot OpenAPI file available
   - Default location: `integration/hubspot-test/companies.json` (relative to workspace root)
...
node integration/hubspot-test/create-hubspot.js \
  --name my-hubspot \
...
source:
  type: openapi-file
  filePath: integration/hubspot-test/companies.json
credential:
  action: skip
preferences:
