...
describe('App Commands Module', () => {
  ...
  describe('updateEnvTemplate', () => {
    ...
    it('should add MISO_CLIENTID and MISO_CLIENTSECRET to env.template when not present', async() => {
    ...
    it('should update existing MISO_CLIENTID and MISO_CLIENTSECRET', async() => {
