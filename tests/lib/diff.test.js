...
describe('Diff Module', () => {
  ...
  describe('compareObjects', () => {
    it('should identify identical objects', () => {
      const { compareObjects } = require('../../lib/diff');
  ...
  describe('identifyBreakingChanges', () => {
    it('should identify removed fields as breaking', () => {
      const { identifyBreakingChanges, compareObjects } = require('../../lib/diff');
  ...
  describe('compareFiles', () => {
    it('should compare identical files', async() => {
      ...
      const { compareFiles } = require('../../lib/diff');
  ...
  describe('formatDiffOutput', () => {
    it('should display identical files message', () => {
      const { formatDiffOutput } = require('../../lib/diff');
      const result = {
        file1: 'file1.json',
        file2: 'file2.json',
        identical: true
