...
In `application.yaml`, the **externalIntegration** block defines external systems and datasources for pipeline deployment.
...
See [External systems](../external-systems.md) and [application.yaml](application-yaml.md).
