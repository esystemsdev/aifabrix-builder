...
**Optional:** app.version, build.localPort, build.dockerfile, build.context, build.envOutputPath, requires.database, requires.databases, requires.redis, requires.storage, healthCheck, authentication, roles, permissions, repository, startupCommand, runtimeVersion, scaling, frontDoorRouting, deployment.controllerUrl, deployment.environment, externalIntegration, configuration (portal UI).
