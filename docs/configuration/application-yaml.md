...
Application config can be **application.yaml**, **application.yml**, or **application.json** on disk; the CLI accepts any of these. Legacy **variables.yaml** is automatically renamed to application.yaml on first use.
