...
async function maybeSyncDatasourceToDataplane({ options, authConfig, dataplaneUrl, systemKey, datasource }) {
...
async function runUnifiedDatasourceValidation(datasourceKey, options) {
  ...
  await maybeSyncDatasourceToDataplane({ options, authConfig, dataplaneUrl, systemKey, datasource });
