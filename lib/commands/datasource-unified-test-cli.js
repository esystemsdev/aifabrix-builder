...
const DATASOURCE_TEST_HELP_AFTER = `
Examples:
  $ aifabrix datasource test test-e2e-hubspot-users
  $ aifabrix datasource test test-e2e-hubspot-users --app test-e2e-hubspot -v
  $ aifabrix datasource test test-e2e-hubspot-users -a test-e2e-hubspot --debug full
  $ aifabrix datasource test test-e2e-hubspot-users --json
`;

const DATASOURCE_TEST_INTEGRATION_HELP_AFTER = `
Examples:
  $ aifabrix datasource test-integration test-e2e-hubspot-users
  $ aifabrix datasource test-integration test-e2e-hubspot-users --app test-e2e-hubspot --debug
  $ aifabrix datasource test-integration test-e2e-hubspot-users -a test-e2e-hubspot -e tst --timeout 60000
`;

const DATASOURCE_TEST_E2E_HELP_AFTER = `
Examples:
  $ aifabrix datasource test-e2e test-e2e-hubspot-users
  $ aifabrix datasource test-e2e test-e2e-hubspot-users --app test-e2e-hubspot -v --debug
  $ aifabrix datasource test-e2e test-e2e-hubspot-users -a test-e2e-hubspot --no-async
  $ aifabrix datasource test-e2e test-e2e-hubspot-users --capability read
`;
...
function chainDatasourceTestCommand(datasource) {
  return datasource
    ...
    .addHelpText('after', DATASOURCE_TEST_HELP_AFTER);
}
...
function chainDatasourceTestIntegrationCommand(datasource) {
  return datasource
    ...
    .option('--warnings-as-errors', 'Exit 1 when root status is warn')
    .option('--require-cert', 'Exit 2 when certificate missing or not_passed')
    .addHelpText('after', DATASOURCE_TEST_INTEGRATION_HELP_AFTER);
}
...
function chainDatasourceTestE2ECommand(datasource) {
  return datasource
    ...
    .option('--warnings-as-errors', 'Exit 1 when root status is warn')
    .option('--require-cert', 'Exit 2 when certificate missing or not_passed')
    .addHelpText('after', DATASOURCE_TEST_E2E_HELP_AFTER);
}
