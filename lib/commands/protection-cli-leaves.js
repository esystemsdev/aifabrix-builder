...
function registerProtectionCreate(protection) {
  const leaf = protection
    ...
    .description(
      'Probe dataplane datasource + Controller dimension, then scaffold under integration/.protection/'
    );
  ...
  leaf
    ...
    .option('--force', 'Overwrite existing integration/.protection/<datasourceKey> manifest')
