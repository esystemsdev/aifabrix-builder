 ...
 * @param {boolean} [options.noSync] - When true, skip publish (exercise dataplane config already deployed)
 * @param {boolean} [options.sync] - Legacy explicit sync; ignored when `noSync` / `--no-sync` is set
