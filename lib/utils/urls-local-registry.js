 ...
 *
 * @fileoverview Read/write registry; scan each builder app folder for application config (yaml/yml/json)
 ...
 * @param {{ excludeCwdBuilderScan?: boolean }} [opts] - When `excludeCwdBuilderScan` is true, do not append
 *   {@link appendCwdProjectBuilderDirIfDistinct} (caller passed an explicit project root, e.g. tests or
 *   `ctx.projectRoot` isolation — avoids merging unrelated checkout `builder/` into `urls.local.yaml`).
