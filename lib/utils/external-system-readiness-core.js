...
/**
 * True when dataplane skipped publish because manifest matches running config.
 * @param {*} publication - Parsed PublicationResult
 * @returns {boolean}
 */
function isPublicationUnchanged(publication) {
  return !!(publication && publication.uploadStatus === 'unchanged');
}
