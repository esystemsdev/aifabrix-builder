 ...
 * `build.envOutputPath` (IDE/host) while `envPath` may hold docker content. Resolve sets this when
 * `applications.<app>.reload` is true and `remote-server` is unset. Otherwise, when `appName`
