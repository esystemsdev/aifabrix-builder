...
const CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'dimension' },
      { name: 'dimension value', term: 'dimension value <command>' },
      { name: 'identity' },
      { name: 'protection' }
    ]
  },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'datasource' },
      { name: 'datasource load', term: 'datasource load <datasourceKey>' },
      { name: 'datasource export', term: 'datasource export <datasourceKey>' },
      ...
      { name: 'verify-operations', term: 'verify-operations <systemKey>' },
      { name: 'verify-trust', term: 'verify-trust <systemKey>' },
      { name: 'verify-governance', term: 'verify-governance <systemKey>' },
      { name: 'lifecycle', term: 'lifecycle <systemKey>' }
    ]
  },
  {
