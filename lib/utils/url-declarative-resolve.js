 ...
 * @param {boolean} [ctx.traefik] - When true and target app has frontDoorRouting.host, public URLs use that template (https by default). Plan 117 `/dev`/`/tst` path prefix applies only when this is true (with scoped-resource flags).
