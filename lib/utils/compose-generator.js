...
function loadDockerComposeTemplate(language) {
  // Use path.resolve to ensure absolute path resolution works in all environments
  const templatePath = path.resolve(__dirname, '..', '..', 'templates', language, 'docker-compose.hbs');
