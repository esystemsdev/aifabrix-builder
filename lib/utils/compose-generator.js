 ...
 */
function buildTraefikConfig(config, devId, scopeOpts = null) {
 ...
 */
function buildServiceConfig(appName, config, port, devId, imageOverride, scopeOpts = null) {
  ...
  return {
    ...
    traefik: buildTraefikConfig(config, devId, useTraefikScope ? scopeOpts : null),
