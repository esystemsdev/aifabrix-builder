...
/**
 * Normalize positional [capabilityKey] for matching envelope.capabilities[].key
 ...
 * }} [options] - When focusCapabilityKey set (positional [capabilityKey]), append single-cap block (plan §2.3).
