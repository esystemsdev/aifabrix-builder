...
const { setupIdentityCommands } = require('../commands/identity');
const { setupProtectionCommands } = require('../commands/protection');
...
const { setupCertificationCommands } = require('./setup-certification-commands');
...
function setupCommands(program) {
  ...
  setupCertificationCommands(program);
