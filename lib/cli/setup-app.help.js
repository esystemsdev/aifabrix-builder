...
Examples:
  ...
  $ aifabrix test-governance protection-test --pack scenarios/protection-test-v1.yaml
  $ aifabrix test-governance protection-test -v --no-sync
  $ aifabrix test-governance protection-test --scenario country-isolation-maria-fi --json
