...
/**
 * @deprecated Prefer {@link module:lib/api/records-bulk.api.bulkSyncRecords}.
...
async function bulkOperation(dataplaneUrl, sourceIdOrKey, authConfig, bulkData) {
  const { bulkSyncRecords } = require('./records-bulk.api');
  return await bulkSyncRecords(dataplaneUrl, sourceIdOrKey, authConfig, bulkData);
}
/** @requiresPermission {Dataplane} external-system:read */
