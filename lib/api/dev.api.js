 ...
 */
async function listSecrets(serverUrl, clientCertPem, serverCaPem) {
  const base = normalizeBaseUrl(serverUrl);
 ...
 */
async function addSecret(serverUrl, clientCertPem, body, serverCaPem) {
  const base = normalizeBaseUrl(serverUrl);
 ...
 */
async function deleteSecret(serverUrl, clientCertPem, key, serverCaPem) {
  const base = normalizeBaseUrl(serverUrl);
