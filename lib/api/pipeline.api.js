...
function buildValidationRunPayloadTestBody({ validationScope, systemKey, datasourceKey, testData = {} }) {
  const payloadTemplate =
    testData.payloadTemplate !== undefined && testData.payloadTemplate !== null
 ...
 * POST /api/v1/validation/run (validationScope=externalSystem, runType=test, payloadTemplate)
