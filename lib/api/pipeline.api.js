 ...
 * @requiresPermission {Dataplane} external-system:publish. Auth: Bearer, API_KEY, or client credentials (x-client-id/x-client-secret).
 * @async
 * @function testSystemViaPipeline
 * @param {string} dataplaneUrl - Dataplane base URL
 * @param {string} systemKey - System key
 * @param {Object} authConfig - Authentication configuration (token or client credentials)
 ...
 * Supports client credentials for CI/CD.
 * @requiresPermission {Dataplane} external-system:publish or external-data-source:read. Auth: Bearer, API_KEY, or client credentials.
 * @async
