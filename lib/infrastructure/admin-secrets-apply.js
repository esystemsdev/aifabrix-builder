 ...
 * @param {(bundle: object) => Promise<void>} [ctx.syncRequiredKvFromPasswordBundle]
...
async function applyAdminSecretsFromBundle(ctx) {
  ...
  if (typeof syncRequiredKvFromPasswordBundle === 'function') {
    await syncRequiredKvFromPasswordBundle(bundle);
  } else if (syncAdminKv && typeof syncAdminKvFromPasswordBundle === 'function') {
