 ...
 *   preferLocalEnvOutputPath (when true with docker profile for `builder/<app>/.env`, `build.envOutputPath` is
 *   written as **local** — resolve uses this only when `applications.<app>.reload` is true and `remote-server` is unset)
