...
/**
 * Effective config directory (same rules as paths.getConfigDirForPaths / AIFABRIX_CONFIG / nested ~/.aifabrix).
 * Resolved on each call so it stays aligned with env and on-disk layout (not frozen at first require).
 * @returns {string}
 */
